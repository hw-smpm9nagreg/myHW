...
const APP_SHELL = [
  ...
  './assets/js/pages/pengumuman.js',
  './assets/js/pages/absensi.js',
  './assets/js/pages/prestasi.js',
  './assets/js/pages/surat.js',
  './assets/js/pages/dokumen.js',
  './assets/js/pages/verifikasi.js',
